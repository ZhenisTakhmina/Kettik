...
struct KTExploreScreenPreview: PreviewProvider {
    
    static var previews: some View {
        KTPreview {
            KTNavigationController(rootViewController: KTExploreScreen(viewModel: .init(tripsCollectionsService: .init(), tripsService: .init())))
